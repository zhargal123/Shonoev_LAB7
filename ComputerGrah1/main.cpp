...
void processInput(GLFWwindow* window)
{
    ...
    if (glfwGetKey(window, GLFW_KEY_N) == GLFW_PRESS) {
        if (angleOX1 < 0.488) {
            ...
            rotateOX1 = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, NewAngle));
            angleOX1 = NewAngle;
        }
    }
    ...
    if (glfwGetKey(window, GLFW_KEY_J) == GLFW_PRESS) {
        if (angleOX2 > -0.45) {
            ...
            rotateOX2 = glm::translate(glm::mat4(1.0f), glm::vec3(NewAngle, 0.0f, 0.0f));
            angleOX2 = NewAngle;
        }
    }
    ...
    if (glfwGetKey(window, GLFW_KEY_I) == GLFW_PRESS) {
        if (angleOX3 > -0.4) {
            float NewAngle = angleOX3 - deltaTime;
            rotateOX3 = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, NewAngle, 0.0f));
            angleOX3 = NewAngle;
        }
    }
